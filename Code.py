...
# Updated Dimensions and Colors for Game
WIDTH = 500
HEIGHT = 500
SPEED = 200
SPACE_SIZE = 20
BODY_SIZE = 2
SNAKE = "#00FF00"  # Bright Green for Snake
FOOD = "#FF0000"   # Red for Food
BACKGROUND = "#333333"  # Dark Grey for Background
SCORE_COLOR = "#FFFFFF" # White for Score Text
...
label = Label(window, text="Points:{}".format(score),
              font=('consolas', 20), fg=SCORE_COLOR, bg=BACKGROUND)
label.pack()
...
# Bind arrow keys to direction change
window.bind('<Left>',
